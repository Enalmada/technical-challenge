            ...
            <div className="container mx-auto  px-8">
                <div className="w-full flex flex-col md:flex-row py-6">
                    ...
                    <div className="flex-1">
                        ...
                        <ul className="list-reset mb-6">
                            <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                <Link href={getRouteById("FAQ").path}>
                    ...
                    <div className="flex-1">
                        ...
                        <ul className="list-reset mb-6">
                            <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                <Link href={getRouteById("Terms").path}>
                                    <a className="no-underline hover:underline text-gray-800 hover:text-orange-500">
                                        Terms
                                    </a>
                                </Link>
                            ...
                            <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                <Link href={getRouteById("Privacy").path}>
                                    <a className="no-underline hover:underline text-gray-800 hover:text-orange-500">
                                        Privacy
                                    </a>
                                </Link>
                    ...
                    <div className="flex-1">
                        ...
                        <ul className="list-reset mb-6">
                            <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                <Link href={getRouteById("Blog").path}>
                                    <a className="no-underline hover:underline text-gray-800 hover:text-orange-500">
                                        Blog
                                    </a>
                                </Link>
                            ...
                            <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                <Link href={getRouteById("Contact").path}>
                                    <a className="no-underline hover:underline text-gray-800 hover:text-orange-500">
                                        Contact
                                    </a>
                                </Link>
